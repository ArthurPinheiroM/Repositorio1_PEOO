...
from templates.alterardadoscliente import AlterarDadosUI
...
class IndexUI:
    ...
    def menu_admin():            
        op = st.sidebar.selectbox("Menu", ["Cadastro de Clientes", "Cadastro de Horários", "Cadastro de Profissionais", "Cadastro de Serviços", "Abrir Agenda do Dia", "Alterar Dados"])
    ...
    def menu_cliente():
        ...
        if op == "Horários Disponíveis":
            ListarHorarioUI.main()
        if op == "Alterar Dados":
            AlterarDadosUI.main()  
